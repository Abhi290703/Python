...
# b = 23
# if(b%2 == 0):
#     print(b,"it is a even number")
# else:
#     print(b,"it is a odd number")
...
# if(a == 35):
#     print(a,"it is greater")
#     if(a>=40):
#         print(a,"it is greater than 40")
#     else:
#         print(a,"it is not greater than 40")
# else:
#     print(a,"it is not greater than 35")
